...
thename <- "\"NLC_example_email_sort\""   #
...
classifierA <- "842c77x336-nlc-507" #     ####  COPY PASTE * YOUR* CLASSIFIER HERE TO CHECK STATUS  ####
...
query <- "I was robbed and they stole my wallet"
watson.nlc.processtextreturnclass(classifierA,query)

query <- "stop spamming me!"
watson.nlc.processtextreturnclass(classifierA,query)
